...
public class AddSAdminForm implements Initializable {
	...
	private void btAddAction() throws SQLException {
		...
		try {
			if (empController.isEmailExist(tfEmail.getText())) {
				...
				setLabel(labelNotice, Color.RED, "Phone number is exist.");
	...
	private void setLabel(Label label, Color color, String text) {
